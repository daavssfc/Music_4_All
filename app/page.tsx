...
export default async function HomePage() {
  const [reviewsData, newsData, eventsData, artistsData] = (await Promise.all([
    fetchJson("/api/reviews?limit=4"),
    fetchJson("/api/news?limit=3"),
    fetchJson("/api/events?limit=3&when=upcoming"),
    fetchJson("/api/artists?limit=3")
  ])) as Array<{ items?: Array<any> } | null>;
