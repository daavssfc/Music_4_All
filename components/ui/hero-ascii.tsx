  ...
  return (
    <main className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-50 pointer-events-none">
        <div className="container mx-auto px-6 lg:px-16 lg:ml-[10%] relative h-full">
          <div className="absolute left-0 top-24 lg:top-28 max-w-lg pointer-events-auto bg-black/85 backdrop-blur-sm p-4 lg:p-6 border border-white/30 shadow-[0_0_30px_rgba(0,0,0,0.7)]">
            {/* Top decorative line */}
