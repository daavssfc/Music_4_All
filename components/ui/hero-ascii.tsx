  ...
  return (
    <main className="relative h-screen overflow-hidden bg-black">
      ...
      <div
        ...
        style={{ position: "absolute", top: "6rem", left: 0, right: 0, zIndex: 50 }}
      >
        <div className="container mx-auto px-6 lg:px-16 lg:ml-[10%]">
          <div
            className="max-w-lg pointer-events-auto bg-black/85 backdrop-blur-sm p-4 lg:p-6 border border-white/30 shadow-[0_0_30px_rgba(0,0,0,0.7)]"
